    ...
    <div>
      <ScrollContainer
        ...
        className={
          ...
          ` w-screen h-screen filter transition-all ease-out duration-200`
        }
        id="test"
      >
        <ResponsiveMasonry
          ...
          <Masonry gutter="40px">
            {numbers.map((el) => (
              <div className="relative inline-block w-full h-full group z-[40]">
               ...
               <div className="transition-all ease-in-out duration-200 right-0 z-[30] flex flex-col gap-[10px] w-full h-full top-0 absolute bg-[#1f3d4738] backdrop-blur-[4px] group-hover:backdrop-blur-0 p-[30px] items-center justify-center ">
